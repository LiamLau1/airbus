...
def g(r):
    ...
    U = 3*k*T * f /(2*100)  #U as a function of f, !!!!!! NEED TO TAKE INTO ACCOUNT NOT ALL PROTONS CONTRIBUTE TO POTENTIAL DIFFERENCE SOMEHOW MODEL THIS
...
'''
lvalue = [integrand2(E, 10**4, 3*k*T * 10**4 /(2*100)) for E in energy]
fig = plt.figure(figsize=[10, 8])  # [12, 10]
plt.plot(energy, lvalue)
plt.show()